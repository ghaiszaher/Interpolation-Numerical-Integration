...
namespace info.lundin.Math
{
    ...
    /// Copyright 2002, 2003, 2004 Patrik Lundin
    ///	
    ...
    public class ExpressionParser
    {
        ...
        Parse(String exp, Hashtable tbl)
        {
            ...
            catch (Exception e)
            {
                ...
                System.Windows.Forms.MessageBox.Show("Invalid function !", "Error !");
                return 0;
            }
        }
        ...
        public bool
                TryParse(String exp, Hashtable tbl)
        {
            double ans = 0D;
            String tmp;
            Node tree;
            ...
            {
                return TryParse(exp, new Hashtable());
            }
